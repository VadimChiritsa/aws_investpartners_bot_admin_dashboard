...
Список пользователей 
		...
		<option value="3" <? if(isset($_SESSION['user_limit']) && $_SESSION['user_limit']==3):?> selected <? endif ?>   >3</option>
		<option value="20" <? if(isset($_SESSION['user_limit']) && $_SESSION['user_limit']==20):?> selected <? endif ?>>20</option>
		<option value="30" <? if(isset($_SESSION['user_limit']) && $_SESSION['user_limit']==30):?> selected <? endif ?>>30</option>
		<option value="50" <? if(isset($_SESSION['user_limit']) && $_SESSION['user_limit']==50):?> selected <? endif ?>>50</option>
	<option value="5000000" <? if(isset($_SESSION['user_limit']) && $_SESSION['user_limit']==5000000):?> selected <? endif ?>>Все</option>
		</select>
	<style>
	 .search-box{
        width: 300px;
	...
	</style><div class="search-box" style="float: right; margin-left: 25px;">
...
Список объявлений | выводить по <select id="sort_ads">
		<option value="3" <? if(isset($_SESSION['ads_limit']) && $_SESSION['ads_limit']==3):?> selected <? endif ?>   >3</option>
		<option value="20" <? if(isset($_SESSION['ads_limit']) && $_SESSION['ads_limit']==20):?> selected <? endif ?>>20</option>
		<option value="30" <? if(isset($_SESSION['ads_limit']) && $_SESSION['ads_limit']==30):?> selected <? endif ?>>30</option>
		<option value="50" <? if(isset($_SESSION['ads_limit']) && $_SESSION['ads_limit']==50):?> selected <? endif ?>>50</option>
	<option value="5000000" <? if(isset($_SESSION['ads_limit']) && $_SESSION['ads_limit']==5000000):?> selected <? endif ?>>Все</option>
		</select>
