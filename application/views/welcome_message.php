...
<form role="form" method="post" action="<?=base_url();?>index.php/login/auth/">
<fieldset>
<div class="form-group">
<input class="form-control" placeholder="Enter you username: durov " name="username" type="text" autofocus>
</div>
</div>
