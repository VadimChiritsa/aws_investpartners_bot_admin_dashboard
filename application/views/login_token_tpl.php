...
<form role="form" method="post" action="<?=base_url();?>index.php/login/auth_token/">
<fieldset>
<div class="form-group">
<input class="form-control" placeholder="Enter you token " name="token" type="text" autofocus>
</div>
</div>
